...
import { listClubs } from "@/lib/master-data";
...
// `clubs`: "Profile data dependency is too broad for launch edits." No
// mutation routes exist for this table.
export default async function ClubsPage() {
  ...
  return (
    <div>
      ...
      {clubs.length === 0 ? (
        <EmptyState title="部活・サークルデータがありません" />
      ) : (
        <TableShell>
          <THead>
            <Th>名称</Th>
