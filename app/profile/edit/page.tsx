...
export default function ProfileEditPage() {
  ...
  if (!mounted) return <div className="min-h-screen bg-[#FFF9FA]" />;

  return (
    <div className="min-h-screen bg-[#FFF9FA] pb-20">
      <div className="w-full max-w-lg mx-auto">
        {/* ヘッダー */}
        <div className="sticky top-0 z-30 bg-white border-b border-orange-100 px-4 py-4 flex items-center gap-3 shadow-sm">
          <button
          ...
          <button
            onClick={handleSave}
            className="flex items-center gap-1.5 bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-sm hover:bg-orange-600 active:scale-95 transition-all"
          >
            <Save size={16} /> 保存
          </button>
        </div>
        ...
        <div className="p-4 space-y-4 animate-fade-in">
          ...
          <Section label="大学名">
            <input
              ...
              placeholder="大学名を入力"
              className="w-full py-3 px-4 rounded-lg border border-gray-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-500"
            />
          </Section>
