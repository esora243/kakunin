      ...
      <div className="px-4 pt-4 space-y-4">
        {allCampaigns.length === 0 ? (
          ...
          allCampaigns.map((campaign) => (
            <Link key={campaign.id} href={`/campaign/${campaign.id}`} className="block bg-white rounded-2xl shadow-sm border border-orange-50 overflow-hidden hover:shadow-md transition-shadow group">
